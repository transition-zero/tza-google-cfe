...
def add_cfe_components_to_brownfield(
    ...
    for bus in buses_with_ci_load:
        ...
        network.loads_t.p_set[bus] = (
            network.loads_t.p_set[bus] - network.loads_t.p_set[ci_load_name]
        )
        ...
        for technology in technology_palette:
            ...
            if technology in network.generators.type.unique():
                ...
                params = (
                    network.generators.loc[network.generators.type == technology]
                    .groupby(by="type")
                    .first()
                    .melt()
                ...
                generator_names = network.generators[
...
if __name__ == "__main__":
    ...
    cfe_brownfield_network = add_cfe_components_to_brownfield(
        ...
        technology_palette=tech_palette,
        p_nom_extendable=False,
        network=brownfield_network,
    )
    cfe_brownfield_network.export_to_netcdf(snakemake.output.cfe_brownfield)
